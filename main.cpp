...
int main()
{
 ...
 Arr[4].piece=Arr[10].piece='r';
 Arr[5].piece=Arr[11].piece='p';
 Arr[0].state=Arr[1].state=Arr[2].state=Arr[3].state=Arr[4].state=Arr[5].state=1;
 Arr[6].state=Arr[7].state=Arr[8].state=Arr[9].state=Arr[10].state=Arr[11].state=0;
 Arr[0].count=Arr[1].count=Arr[6].count=Arr[7].count=1;
...
Arr[5].count=Arr[11].count=8;
    ...
    for (i = 0; i < img1.rows; i++)
	{
        ...
        if(flag)
>>>>>>> 9df367f504b9cb898212434945e051c01f2f4bfa
        break;
      }
    }
